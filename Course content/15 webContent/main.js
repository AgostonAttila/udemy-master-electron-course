...
//Új ablakban nyitja meg ,vagy modalban
/*
mainContents.on('did-finish-load',()=>{
  console.log('Google Loaded');
}) */
/*
mainContents.on('new-windows',(e,url)=>{
  e.preventDefault();
  let modalWindow =  new BrowserWindow({width: 400, height: 300,modal : true , parent: mainWindow})
...
//Navigál akar és amikor megcsinálta
/*
